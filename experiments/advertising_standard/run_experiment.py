...
# Load dataset path (absolute)
DATA_PATH = "/Users/konstantinospanagiotaropoulos/Desktop/College/Pythia/data/advertising_dataset.csv"
...
# Log to MongoDB
log_experiment_result("advertising_standard", "LinearRegression", {"r2_score": r2, "mae": mae})

print("Advertising standard experiment complete. Results saved and logged to MongoDB.")
