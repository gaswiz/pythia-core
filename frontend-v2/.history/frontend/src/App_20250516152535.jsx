...
import Marquee3D from './components/Marquee3D.jsx'; // <-- move this import up for clarity
...
function App() {
  return (
    <div className="App">
      ...
      {/* ✅ INSERTED 3D MARQUEE RIGHT AFTER HERO */}
      <section id="marquee"><Marquee3D /></section>
