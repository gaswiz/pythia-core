  ...
  return (
    <div className="w-full" {...getRootProps()}>
      ...
      >
        ...
        {/* Blue dashed background border that stays behind */}
        <div className="absolute inset-0 z-10 flex items-center justify-center">
          <div className="h-32 max-w-[8rem] w-full border-2 border-dashed border-blue-500 rounded-md"></div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center relative z-20">
          <p className="font-bold text-neutral-700 dark:text-neutral-300">Upload file</p>
          <p className="text-neutral-400 mt-2">Drag or drop your files here or click to upload</p>
          ...
          <div className="relative w-full mt-10 max-w-xl mx-auto">
            {files.length > 0 ? (
              ...
              <motion.div
                ...
                className="relative z-40 bg-white dark:bg-neutral-900 flex items-center justify-center h-32 w-full max-w-[8rem] mx-auto rounded-md shadow-md"
              >
                {isDragActive ? (
