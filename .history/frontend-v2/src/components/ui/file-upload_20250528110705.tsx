          ...
          <div className="relative w-full mt-10 max-w-xl mx-auto">
            {files.length > 0 ? (
              ...
              <motion.div
                ...
                className="relative group-hover/file:shadow-2xl z-40 bg-white dark:bg-neutral-900 flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md shadow-md border-2 border-dashed border-blue-500"
              >
                {isDragActive ? (
