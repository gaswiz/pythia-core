...
export default function ForecastReport({ data, formData }) {
  ...
  return (
    <section className="w-full px-6 py-12 bg-white dark:bg-black">
      <div className="max-w-screen-xl mx-auto">
        <div className="rounded-xl bg-white dark:bg-zinc-900 shadow-input p-8 space-y-6">
          <h3 className="text-xl font-bold text-neutral-800 dark:text-white">
            Forecast Summary
          </h3>

          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm text-neutral-600 dark:text-neutral-300">
          ...
          <div className="pt-4">
            <ResponsiveContainer width="100%" height={360}>
              <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                ...
                <XAxis type="number" dataKey="x" name="Input" tick={{ fill: '#888' }} />
                <YAxis type="number" dataKey="y" name="Prediction" tick={{ fill: '#888' }} />
                <Tooltip
