/*
  ...
  Description: Animated hero section customized for P.Y.T.H.I.A.
*/
    ...
    <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-slate-100 md:text-4xl lg:text-7xl dark:text-slate-300">
          {"Predict Your Campaign Success with P.Y.T.H.I.A.".split(" ").map((word, index) => (
            <motion.span
              key={index}
        ...
        >
          Empower your marketing strategy with intelligent analytics. P.Y.T.H.I.A. helps you forecast impressions, CTR, and conversions before launch.
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <div className="w-full overflow-hidden rounded-xl border border-gray-300 dark:border-gray-700">
            <img
              ...
              alt="P.Y.T.H.I.A. dashboard preview"
...
const Navbar = () => {
  return (
    <nav className="flex w-full items-center justify-between border-t border-b border-neutral-200 px-4 py-4 dark:border-neutral-800">
      ...
      <button className="w-24 transform rounded-lg bg-purple-600 px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-purple-700 md:w-32">
        GitHub
      </button>
    </nav>
  );
