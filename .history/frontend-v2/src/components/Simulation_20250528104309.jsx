    ...
    <section className="w-full bg-black text-white py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <select className="p-3 bg-neutral-900 border border-white text-white">
          ...
          <input
            type="number"
            placeholder="Budget (€)"
            className="p-3 bg-neutral-900 border border-white text-white"
          />
          <input
            type="number"
          ...
          <button
            type="button"
            className="col-span-full mt-4 bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3"
          >
            Run Simulation
          </button>
        </form>
