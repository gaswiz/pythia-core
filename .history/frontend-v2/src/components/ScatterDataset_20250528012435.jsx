// File path: src/components/ScatterDataset.jsx
...
export default function ScatterDataset() {
  return (
    <div className="bg-black text-white p-6 border border-white rounded-none">
      <h2 className="text-2xl font-semibold mb-4 text-purple-300 text-center">
        Forecast Scatter Analysis
      </h2>
      <ScatterChart
        dataset={dataset}
        series={[
          { datasetKey: 'version', xKey: 'a1', yKey: 'a2', label: 'Series A' },
          { datasetKey: 'version', xKey: 'b1', yKey: 'b2', label: 'Series B' },
        ]}
        {...chartSetting}
      />
    </div>
