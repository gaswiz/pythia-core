...
----------------------------------------
Updated and recommended secure configuration.
"""
...
load_dotenv()
df = pd.read_csv("/Users/konstantinospanagiotaropoulos/Desktop/College/Pythia/data/marketing_campaign_dataset.csv")
print(df.columns)
...
explainer = shap.Explainer(cls_model.predict_proba, shap.maskers.Independent(X_background))
